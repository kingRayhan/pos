...
<script>
    export default {
        mounted(){
            ...
            const ProductSearchHeight = document.querySelector('.search-input').clientHeight;

            const CategoryWrapper = document.querySelector('#categoryList');


            ProductListWrapper.style.setProperty('height' , `${BodyHeight - (NavbarHeight + ProductSearchHeight)}px`);
